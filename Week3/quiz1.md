...
- 답:unmodified,modified,unmerged

### Q2
Git에는 세 가지 영역이 있다.  
세 가지 영역을 모두 나열하시오.

- 답: Working Directory, stageing area,local repository
...
- 답: 현재 develop이라는 브랜치에서 작업중이다.문서 파일인 readme를 추가했다.
...
- 답: revert, reset은 commit을 삭제하기때문에 commit을 공유하는 다른 브랜치에 영향을 줄 수 있기 때문이다.
